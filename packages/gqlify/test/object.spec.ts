...
describe('Tests on fixtures/object.graphql with Firebase Data Source', function() {
  this.timeout(20000);
...
describe('Tests on fixtures/object.graphql with Firestore Data Source', function() {
  this.timeout(20000);
  ...
  afterEach(async () => {
    const collectionRef = (this as any).firestore.collection('canner-object');
